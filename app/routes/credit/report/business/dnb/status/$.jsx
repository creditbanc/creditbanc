...
const credit_report = subject.pipe(
	...
	concatMap(({ args: { request } }) => {
		...
		return is_authorized.pipe(
			...
			tap((value) => {
				console.log("credit.report.business.dnb.status.tap");
				console.log(value);
			})
		);
	})
...
export const loader = async ({ request }) => {
	const on_success = async (response) => {
		console.log("credit.report.business.dnb.status.success");
	...
	const on_error = (error) => {
		console.log("credit.report.business.dnb.status.error");
		console.log(error);
