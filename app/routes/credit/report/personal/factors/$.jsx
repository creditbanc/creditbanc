...
import { get_file_id, get_group_id, inspect, mapIndexed } from "~/utils/helpers";
...
export const loader = async ({ request }) => {
	...
	let response = report.factors.fold;
...
// 			concatMap(() => report),
// 			tap((value) => {
// 				console.log("credit.report.personal.factors.tap");
// 				console.log(value);
// 			})
// 		);
// 	})
...
// 		console.log("credit.report.personal.factors.success");
...
// 	const on_error = (error) => {
// 		console.log("credit.report.personal.factors.error");
// 		console.log(error);
