...
// 				throwError(() =>
// 					Response.redirect(`${url.origin}/credit/personal/new/resource/e/${entity_id}/g/${group_id}`)
// 				)
// 			)
// 		);
...
// 				concatMap(() => ArrayExternal.refreshDisplayToken(clientKey, reportKey)),
// 				catchError((error) => {
...
// 		experian_personal_score = personal_report.pipe(rxmap((report) => report.experian_score()));

// 		equifax_personal_score = personal_report.pipe(rxmap((report) => report.equifax_score()));

// 		transunion_personal_score = personal_report.pipe(rxmap((report) => report.transunion_score()));

// 		let first_name = personal_report.pipe(rxmap((report) => report.first_name()));

// 		let last_name = personal_report.pipe(rxmap((report) => report.last_name()));
