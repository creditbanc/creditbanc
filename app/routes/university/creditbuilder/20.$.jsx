		...
		<div className="w-full text-base leading-7 text-gray-700 px-3 my-4">
			<div className="mt-10 max-w-2xl">
				...
				<div className="flex flex-col gap-y-5">
					<p>
						Just as it is important for an individual to understand their personal credit reports, it is
						important for businesses to understand what is on their business credit report. Every business
						credit bureau has their own scoring models and monitoring service. Brush up on your skills and
						read your Business Equifax report.
					</p>
					<p>
						Be proactive, identify what your goals are with your business credit reports. Do you want to get
						more financing in the future? Get higher credit limits?
					</p>
				</div>
			</div>
			<div className="mt-10">
