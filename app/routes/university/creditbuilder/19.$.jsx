		...
		<div className="w-full text-base leading-7 text-gray-700 px-3 my-4">
			<div className="mt-10 max-w-2xl">
				<h2 className="mt-8 text-2xl font-bold tracking-tight text-gray-900 my-3">
					SET UP BUSINESS EXPERIAN MONITORING
				</h2>
				<div className="flex flex-col gap-y-5">
					<p>
						Every business credit bureau has their own monitoring and scoring models. It’s important to
						monitor your business credit reports regularly so you are aware of any changes.
					</p>
					<p>
						We have our free feed that tells you how many trade accounts are reporting but to see the full
						detail including whether payments are on time or not Experian requires that you purchase
						monitoring.
					</p>
					<p>Be proactive. What are your goals with your business credit reports? Increase credit limits?</p>
				</div>
			</div>
			<div className="mt-10">
