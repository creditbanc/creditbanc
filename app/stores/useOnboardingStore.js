...
export const default_onboard_state = [
	...
	},
	{
		...
		completed: false,
		category: "credit",
		href: ({ entity_id, group_id }) => `/credit/business/new/resource/e/${entity_id}/g/${group_id}?cookie=monster`,
		completed_href: ({ entity_id, group_id }) =>
	...
	// },
	{
		...
		completed: false,
		category: "social",
		href: ({ entity_id, group_id }) => `/roles/resource/e/${entity_id}/g/${group_id}`,
	},
];
