 ...
 * Original file: /npm/animal-avatar-generator-module@1.0.6/dist/index.js
 *
 * Do NOT use SRI with dynamically generated files! More information: https://www.jsdelivr.com/using-sri-with-dynamic-files
 */
const c = -(2 ** 31),
	l = (c, l) => c[a(l, 0, c.length - 1)],
	a = (l, a, f) => Math.floor(((l - c) / 4294967295) * (f + 1 - a) + a),
	f = (c) => {
		let l = z(c);
		return () => (l = n(l));
	},
	...
	z = (c) =>
		c
			...
			.reduce((c, l) => t((c << 5) - c + l), 0),
	t = (c) => 0 | c,
	r = ["#fcf7d1", "#ece2e1", "#e4e3cd", "#c4ddd6", "#b5f4bc"],
	h = ["#d7b89c", "#b18272", "#ec8a90", "#a1Ac88", "#99c9bd", "#50c8c6"],
	p = [
		(c) =>
	...
	v = [
		(c) =>
			`\n    <path fill="${c}" d="M440.7 280.2c0 6.7-.4 13.1-1.2 19.2-1.1 7.9-2.9 15.2-5.3 21.9a86.3 86.3 0 01-20.7 32.6C393 374.3 362 385.2 325 390.6c-23 3.3-48.3 4.5-74.9 4.5a529 529 0 01-75-4.6c-68-9.8-115.7-38.4-115.7-110.3 0-96.3 85.4-174.3 190.7-174.3 95.7 0 175 64.4 188.6 148.3a161 161 0 012.1 26z"/>\n  `,
	],
	o = [
		(c) =>
	...
	m = [
		...
		(c) =>
			`\n    <ellipse cx="250" cy="299.3" fill="${d(
				c,
				30
			)}" rx="39.7" ry="27.6"/>\n    <path fill="${d(
				c,
	...
	b = [
		...
		(c) =>
			`\n    <ellipse cx="323.8" cy="217.4" fill="${d(
				c,
				-30
		...
		return ((c, ...l) =>
			...
			M
				? ((c) =>
						`\n  <path\n    d="${
							c
								? "M250,0a250,250 0 1,1 0,500"
								: "M250,0L500,0L500,500L250,500"
						}"\n    fill="#15212a"\n    fill-opacity="0.08"\n  />\n`)(
						z
				  )
				: ""
...
export { C as default };
//# sourceMappingURL=/sm/2ee4846a40f906e0c70a9f74925a345f2d6ea082e596c893a93dbb7af4cd3ea3.map
