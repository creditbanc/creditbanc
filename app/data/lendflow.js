...
export const mrm_credit_report_ = {
	data: {
...
export const mrm_credit_report = {
	application_id: "d6d6cb45-0818-4f43-a8cd-29208f0cf7b2",
	id: "d6d6cb45-0818-4f43-a8cd-29208f0cf7b2",
	request: {
	...
	data: {
		uuid: "80d611ea-e6e8-427b-9158-12670042fcae",
		business_legal_name: "MRM Capital holdings",
		dates: {
			experian_business_facts: "2023-07-13 21:41:37",
			experian_trades: "2023-07-13 21:41:31",
			experian_intelliscore: "2023-07-13 21:41:28",
			experian_business_match: "2023-07-13 21:41:26",
			dnb_pi_l3: "2023-07-13 21:41:26",
			dnb_fi_l2: "2023-07-13 21:41:26",
			dnb_ci_l2: "2023-07-13 21:41:26",
		},
		statuses: {
			middesk: "Not yet started",
			dnb: {
			...
			ekata: "Not yet started",
			heron: "Not yet started",
			equifax: { bpr: "Not yet started" },
			scorely: "Not yet started",
			tax_status: {
				business: { verify: "Not yet started" },
				individual: { verify: "Not yet started" },
			},
			blu_cognition: "Not yet started",
			clear: {
				person_search: "Not yet started",
				clear_id_confirm_person: "Not yet started",
				clear_risk_inform_person_search: "Not yet started",
			...
			socure: { kyc: "Not yet started", fraud: "Not yet started" },
			lexis_nexis: {
				kyc: "Not yet started",
				kyc_report: "Not yet started",
				kyb_search: "Not yet started",
		...
		commercial_data: {
			...
			experian: {
				intelliscore: {
					...
					commercialScore: {
						...
						modelTitle: "INTELLISCORE PLUS V2",
						customModelCode: "03",
						percentileRanking: 72,
						recommendedCreditLimitAmount: 31700,
					},
					commercialScoreTrends: [
						{ score: 72, quarter: "APR-JUN" },
						{ score: 71, quarter: "JAN-MAR" },
						{ score: 68, quarter: "OCT-DEC" },
						{ score: 62, quarter: "JUL-SEP" },
					],
					commercialScoreFactors: [
						{
							code: "045",
				...
				trades: {
					...
					tradePaymentTotals: {
						tradelines: {
							...
							tradelineCount: 4,
							currentPercentage: 100,
							totalAccountBalance: { amount: 34000 },
							totalHighCreditAmount: { amount: 91600 },
						},
						combinedTradelines: {
							dbt30: 0,
							dbt60: 0,
							...
							tradelineCount: 2,
							currentPercentage: 100,
							totalAccountBalance: { amount: 32900 },
							totalHighCreditAmount: { amount: 63100 },
						},
						additionalTradelines: {
							dbt30: 0,
							dbt60: 0,
							...
							tradelineCount: 2,
							currentPercentage: 100,
							totalAccountBalance: { amount: 1100 },
							totalHighCreditAmount: { amount: 28500 },
						},
						newlyReportedTradelines: {
							dbt30: 0,
							dbt60: 0,
							...
							totalHighCreditAmount: { amount: 0 },
						},
						continuouslyReportedTradelines: {
							dbt30: 0,
							dbt60: 0,
					...
					tradePaymentTrends: {
						monthlyTrends: [
							...
							},
							{
								...
								dbt91Plus: 0,
								currentPercentage: 100,
								totalAccountBalance: { amount: 34500 },
							},
							{
								dbt: 0,
								date: "2023-05-01",
								...
								dbt91Plus: 0,
								currentPercentage: 100,
								totalAccountBalance: { amount: 36200 },
							},
							{
								dbt: 0,
								date: "2023-04-01",
								...
								dbt91Plus: 0,
								currentPercentage: 100,
								totalAccountBalance: { amount: 37800 },
							},
							{
								dbt: 0,
								date: "2023-03-01",
								...
								dbt91Plus: 0,
								currentPercentage: 100,
								totalAccountBalance: { amount: 41100 },
							},
							{
								dbt: 0,
								date: "2023-02-01",
							...
							},
							{
								...
								dbt91Plus: 0,
								currentPercentage: 100,
								totalAccountBalance: { amount: 42700 },
							},
						],
						quarterlyTrends: [
							{
							...
							},
							{
								...
								dbt91Plus: 0,
								currentPercentage: 100,
								totalAccountBalance: { amount: 40000 },
							},
							{
								dbt: 0,
								date: "2022-10-01",
								...
								dbt91Plus: 0,
								currentPercentage: 100,
								totalAccountBalance: { amount: 44700 },
							},
							{
								dbt: 0,
								date: "2022-07-01",
								...
								dbt91Plus: 0,
								currentPercentage: 100,
								totalAccountBalance: { amount: 49100 },
							},
							{
								dbt: 0,
								date: "2022-04-01",
								...
								dbt91Plus: 0,
								currentPercentage: 100,
								totalAccountBalance: { amount: 53900 },
							},
						],
					},
					tradePaymentSummary: {
						currentDbt: 0,
						singleHighCredit: 63100,
						allTradelineCount: 4,
						highestDbt6Months: 0,
						monthlyAverageDbt: 0,
						allTradelineBalance: 34000,
						highestDbt5Quarters: 0,
						currentAccountBalance: 32900,
						currentTradelineCount: 2,
						medianCreditAmountExtended: null,
					},
					tradePaymentExperiences: {
						tradeAdditional: [
							{
								...
								accountBalance: { amount: 1100 },
								businessCategory: "BANK CARD",
								dateLastActivity: null,
								recentHighCredit: { amount: 28500 },
								currentPercentage: 100,
								newlyReportedIndicator: false,
								customerDisputeIndicator: false,
							},
						...
						tradeNewAndContinuous: [
							...
							},
							{
								...
								dbt91Plus: 0,
								dateReported: "2023-06-01",
								accountBalance: { amount: 32900 },
								businessCategory: "FINCL SVCS",
								dateLastActivity: null,
								recentHighCredit: { amount: 63100 },
								currentPercentage: 100,
								newlyReportedIndicator: false,
								customerDisputeIndicator: false,
							},
				...
				business_match: {
					...
					created_at: "2023-07-13T21:41:28.000000Z",
					updated_at: "2023-07-13T21:41:28.000000Z",
					business_credit_service: "experian_business_match",
					business_id: 392984,
					request: {
						geo: true,
			...
			dnb: {
				...
				fi_l2: {
					...
					organization: {
						...
						tsrRating: [],
						layOffScore: {
							scoreDate: "2023-06-26",
							classScore: 2,
							probability: 0.02,
							classScoreDescription: "moderately low",
							nationalRiskPercentile: 56,
						},
						primaryName: "MRM Capital Holdings, Inc.",
						dnbAssessment: {
							failureScore: {
				...
				ci_l2: {
					...
					organization: {
						...
						financials: [
							{
								unitCode: "SingleUnits",
								yearlyRevenue: [{ value: 0, currency: "USD" }],
								reliabilityDnBCode: 9094,
								reliabilityDescription: "Modelled",
								informationScopeDnBCode: 9067,
								financialStatementToDate: "2022-03-14",
						...
						isExporter: null,
						isImporter: null,
						charterType: { dnbCode: 9123, description: "Profit" },
						primaryName: "MRM Capital Holdings, Inc.",
						unspscCodes: [
							{
								code: "84000000",
						...
						primaryAddress: {
							...
							addressLocality: { name: "Winter Garden" },
							statisticalArea: {
								economicAreaOfInfluenceCode: "121",
							},
						...
						businessTrustIndex: {
							scoreDate: "2021-05",
							trustClass: { dnbCode: 13693, description: "Low" },
							trustIndex: 0,
							dataProvider: [],
							scoreReasons: [],
							nationalPercentile: null,
						...
						businessTradingNorms: [
							{
								industryNorms: {
									normsKey: "US#6719",
									normsDate: "2023-06-30",
									paydexScoreNorms: {
										medianScore: 80,
										lowerQuartileScore: 80,
										upperQuartileScore: 80,
									},
									paymentBehaviourNorms: {
										medianResult: { dnbCode: 1232 },
										medianDaysQuantity: 0,
										lowerQuartileResult: { dnbCode: 1232 },
										upperQuartileResult: { dnbCode: 1232 },
										lowerQuartileDaysQuantity: 0,
										upperQuartileDaysQuantity: 0,
									},
								},
								calculationTimestamp: "2023-06-30",
							},
						],
						countryISOAlpha2Code: "US",
						normsCalculationTimestamp: "2023-07-01",
					},
					inquiryDetail: {
						duns: "017519793",
						blockIDs: ["paymentinsight_L3_v1"],
				...
				bm_l1: {
							...
							},
							{
								organization: {
									...
									primaryAddress: {
										...
										streetAddress: {
											line1: "11054 Hanlon Terrace Aly",
											line2: null,
										},
										addressCountry: {
											name: "United States",
							...
							},
							{
								organization: {
									...
									primaryAddress: {
										...
										addressLocality: { name: "KISSIMMEE" },
										postalCodeExtension: "6610",
									},
									websiteAddress: [],
									tradeStyleNames: [],
					...
					created_at: "2023-07-13T21:41:27.000000Z",
					updated_at: "2023-07-13T21:41:27.000000Z",
					business_credit_service: "dnb_bm_l1",
					business_id: 392984,
					request: {
						duns: "",
			...
			tax_status: {
				business: { verify: null },
				individual: { verify: null },
			},
			blu_cognition: null,
			clear: {
				person_search: null,
			...
			enigma: { business_match: null, business_lookup: null },
			equifax: { bpr: null },
			scorely: null,
			ekata: null,
			socure: { kyc: null, fraud: null },
			lexis_nexis: {
				kyc: null,
				kyc_report: null,
				kyb_search: null,
			...
			moneythumb_cfa: null,
			moneythumb_transactions: null,
			heron: { pnl: null, pnl_transactions: null },
			document_verifications: [],
		},
		request_data: {
			middesk: null,
