				...
				<div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
					<div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
						...
						<p className="mt-6 text-lg text-gray-600">
							Build Your Business Credit . Access Capital. Monitor
							Your Personal Credit all in one place
						</p>
						<p className="mt-6 text-lg text-gray-600">
							Be the first to apply and earn a chance to win VIP
							access worth $100
						</p>
						<div className="mt-8 flex flex-wrap gap-x-6 gap-y-4">
							<form className="flex w-auto justify-center ">
								<input
									type="email"
									...
									autoComplete="email"
									required
									className="w-60 min-w-0 shrink border rounded pl-[10px]"
								/>
								<Button
									type="submit"
									color="cyan"
